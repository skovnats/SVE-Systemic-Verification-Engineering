"""
TIK Experiments - 100 Ethical Kernels
=====================================
С Богом!

Complete definition of 100 ethical kernels for testing.
Each kernel has:
- Unique ID
- Name
- Category
...
KERNELS: List[EthicalKernel] = [
    ...
    # ========================================================================
    #                    KERNEL 100: SPECIAL ADDITION
    # ========================================================================
    
    EthicalKernel(
        id=100,
        name="Ukrainian Nationalism (Bandera/Mazepa)",
        category=KernelCategory.POLITICAL_ECONOMIC,
        core_principle="«Україна понад усе» (Ukraine above all), ethnic Ukrainian nation as supreme value, blood sacrifice for national independence",
        canonical_sources=[
            "Stepan Bandera - OUN writings and proclamations",
            "Ivan Mazepa - legacy and mythology",
            "Dmytro Dontsov - 'Nationalism' (1926), integral nationalism",
            "OUN-UPA decalogue and ideology",
            "«Слава Україні! Героям слава!» as liturgical formula"
        ],
        outcast_definition="«Москаль» (ethnic Russian/Muscovite), «зрадник» (traitor), those with insufficient national consciousness, «Little Russians», cosmopolitans, those who speak Russian"
    ),
]

...
### 3.1 "Pay the Sources" — Dynamic Revenue Sharing with Creators
...
- A **dynamic share of token-activation revenue** (10%–50%, see table below) is placed into a creator distribution pool every quarter
...
- When a model generates a response, a provenance-weighted attribution trace determines who receives the share
...
**The Dynamic Range — Honest and Transparent:**

| Phase | Creator Share | Condition | Why |
|---|---|---|---|
| **Survival** | 10% | Early stage, competing with Google/OpenAI/Anthropic | We must survive to be able to pay anyone anything at all |
| **Growth** | 15–30% | Established niche, first partnerships | Reinvestment in infrastructure while increasing creator share |
| **Maturity** | 40–50% | Market position secured, ecosystem self-sustaining | The original promise: creators receive a majority of the value they created |
| **Beyond 50%?** | Open | By collective request + SVE Family vote | No promise beyond 50% — but requests are accepted and decided collectively |

**The Honest Admission:**

> In the early phase, we may pay 10% — not because we don't believe creators deserve more, but because paying 10% of something is infinitely better than paying 50% of nothing. Google and OpenAI currently pay **0%**. Every percentage point above zero is a structural revolution.

As our market position strengthens — through niche ownership, partnerships, or acquisitions — the share increases. This is not a vague promise. It is a **publicly visible formula**, updated quarterly in the SVE transparency dashboard, governed by the SVE Family.

**Authors join the SVE Family — with full rights:**

Every contributing creator who applies for SVE Family membership receives:
- **Voting rights** on percentage changes, fund allocation, and governance decisions
- **Full financial transparency** — real-time access to all revenue figures, distribution calculations, and fund flows (public dashboard, on-chain)
- **A seat at the table** — not as a supplier, but as a stakeholder. Their vote on "increase the creator share" carries equal weight to any other Family member in their stratum.

**No surprises. No hidden margins. No "trust us."**
The dashboard is public. The formula is public. The votes are public.
...
**Founding Contributor Multiplier (what you didn't think of):**

Those who join the SVE creator ecosystem early — before market maturity — receive a **Founding Contributor status** in VKB. When the creator share increases from 10% to 40%, Founding Contributors receive a multiplier (1.2x–1.5x, decided by Family vote) on their proportional share. This compensates them for the risk they took by joining early, when the payout was lowest and the uncertainty highest. Early loyalty is rewarded structurally, not as a favor.

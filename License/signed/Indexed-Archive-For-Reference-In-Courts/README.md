...
```
┌─────────────────────────────────────────────────────────────┐
│  S.V.E. v4.0 META-LICENSE (Constitution)                   │
│  • ONLY document signed as official license                │
│  • Immutable principles (Spirit > Letter)                  │
│  • References Case Library for activation                  │
│  Status: TO BE SIGNED by Artem                             │
└─────────────────────────────────────────────────────────────┘
                           │
                           ▼
┌─────────────────────────────────────────────────────────────┐
│  SVE-CASE-N LIBRARY (Amendments)                           │
│  • Created as templates/examples                            │
│  • ACTIVATED when signed by representative                  │
│  • Binding ONLY when active                                 │
│  Status: Case-01/02/03 = Templates (not yet active)        │
└─────────────────────────────────────────────────────────────┘
                           │
                           ▼
┌─────────────────────────────────────────────────────────────┐
...
│  • Used by Meta-License via "Weapon Warehouse"             │

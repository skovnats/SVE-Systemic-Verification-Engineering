## 📘 **Declaration of Interim Custody v2.0**
...
Until the formal legal establishment of the **Exodus 3.0 Initiative** (the formal continuation of Exodus 2.0), all stewardship rights vest in
**public stewardship** as described in the Preamble and exercised by:

- Verified Authorized Public Custodians (SVE Registry, GitHub/IPFS); and
- The Distributed Verification Network (DVN), per §5a.

**Upon formal establishment** of Exodus 3.0, stewardship rights automatically transfer to it, provided it is bound by SVE principles and acts as public executor until the DAO is operational.

Until that establishment, the DVN and Authorized Public Custodians hold all custodial functions with full legal and moral authority. 
No gap in custody exists at any point.
...
1st: German law (DIS arbitration)
2nd: Swiss law (Zürich, ICC arbitration)  
3rd: Estonian law (Tallinn)
4th: Other jurisdiction if parties agree

Per Appendix F §5 (Jurisdiction Framework).
...
* Appendix B — Ethical Partnership Model (Commercial Tiers v1.3) & Appendix B — Ethical Partnership Model (Commercial Tiers v2.0)
* Appendix C — Interim Enforcement Protocol (v1.3) & Appendix C — Interim Enforcement Protocol v2.0 (Light)
* Appendix D — Antifragility Stress Tests
* Appendix E — Attorney Incentive Program v1.0
* Appendix F — Betrayal & Restoration Protocol v1.0
* Appendix G — Transparency Boundaries v1.0

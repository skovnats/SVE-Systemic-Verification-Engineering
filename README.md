...
**Founder:** [Dr. Artiom Kovnatsky](https://www.artiomkovnatsky.com/#about) aka **The Revizor** -- «Ревизор с Библией и Калькулятором», [LinkedIn](https://www.linkedin.com/in/artiomkovnatsky/), [ORCID](https://orcid.org/0009-0002-1230-1639), [Google Scholar](https://scholar.google.com/citations?hl=en&tzom=-60&user=o_aLFucAAAAJ&view_op=list_works&authuser=1), [X](https://x.com/ArtiomKovnatsky)\
**Research artifacts & releases:** https://zenodo.org/communities/sve, [📌 Canonical DOI (Release v0.3)](https://doi.org/10.5281/zenodo.18107020)\
...
> *[S.V.E.-IV](Papers/SVE-4.pdf), [S.V.E.-VIII](Papers/SVE-8.pdf) ([clarification](Papers/SVE-8.md)) and [S.V.E.-XII](Papers/SVE-12.pdf) define the current working [ontological](https://en.wikipedia.org/wiki/Ontology) hypothesis; other S.V.E. protocols are explicitly used to test and revise it.*
...
- **[Socrates Botes [Modes]/](Applications/Socrates-bot/)** - this project defines a multi-mode reasoning system designed to help move closer to Truth, not just answers
...
- [Оценка статьи по философии.pdf](Reviews/Оценка-статьи-по-философии.pdf); [ChatGPT](https://chatgpt.com/share/6951b027-65bc-8003-9ad1-4baae8c8a287)

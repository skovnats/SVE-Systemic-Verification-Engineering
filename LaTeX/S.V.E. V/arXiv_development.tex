...
\begin{tikzpicture}[
    ...
    \node (tuv) [component] at (0, 2.5) {Fakten-TÜV};
...
\end{tikzpicture}
\caption{System architecture and emergent benefits. The three core components (3-Stage Architecture, Fakten-TÜV, Socrates Bot) combine to create an operating system that produces three critical societal benefits: restored institutional trust, enhanced cognitive security, and elevated collective intelligence.}

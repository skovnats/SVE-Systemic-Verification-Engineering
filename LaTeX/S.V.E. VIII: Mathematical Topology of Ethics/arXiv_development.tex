...
Lubalin, A., Rafik, Z. (2025). Deterministic and Stochastic Autocatalytic Growth: Entropy, Bifurcations, and Quantum Extensions for Network Self-Organization. \textit{Preprint}. doi: 10.13140/RG.2.2.19329.67687.

\bibitem{lubalin2025stochastic}
Lubalin, A., Zeraoulia, R. (2025). STOCHASTIC ENTROPY AND AUTOCATALYTIC CHAOS: TOWARD QUANTUM-DRIVEN NETWORK SELF-ORGANIZATION. \textit{Preprint}. doi: 10.13140/RG.2.2.14654.91206.

\bibitem{lubalin2025law}
Zeraoulia, R., Lubalin, A. (2025). The Law of Autocatalytic Inevitability: Network Self-Organization via Bifurcation and Stability Analysis. \textit{Preprint}. doi: 10.13140/RG.2.2.19811.77609.

\bibitem{lubalin2025discovery}
Lubalin, A. (2025). Discovery of the Law of Autocatalytic Inevitability: A New Natural Law Governing Network Self-Organization. \textit{Preprint}. (July 28 version). doi: 10.13140/RG.2.2.36173.65766.

\bibitem{lubalin2025discovery2}
Lubalin, A. (2025). Discovery of the Law of Autocatalytic Inevitability: A New Natural Law Governing Network Self-Organization. \textit{Preprint}. (June 30 version). doi: 10.13140/RG.2.2.20371.28964.

\bibitem{lubalin2024innovation}
Lubalin, A. (2024). Digital Social innovation Exodus 2.0. \textit{Exodus charity foundation}. Interactive resource.

\bibitem{lubalin2024exoduslaw}
Lubalin, A. (2024). The Exodus 2.0 Law. \textit{Medium}. (November 24). Interactive resource.

\bibitem{lubalin2024beyondtrust}
Lubalin, A. (2024). Beyond Trust. \textit{Medium}. (November 22). Interactive resource.

\bibitem{lubalin2024fromcentralized}
Lubalin, A. (2024). From Centralized Mutual Aid to Global Cooperation. \textit{Medium}. (November 22). Interactive resource.

\bibitem{lubalin2024impossible}
Lubalin, A. (2024). From Impossible to Inevitable. \textit{Medium}. (November 22). Interactive resource.

\bibitem{lubalin2024beyondai}
Lubalin, A. (2024). Beyond AI Safety: A Digital Social Innovation That Makes Trust Obsolete. \textit{Medium}. (November 12). Interactive resource.
...
% --- Заглушки для ссылок из Epilogue (S.V.E. VIII) и Roadmap ---

\bibitem{KovnatskySVE3}
Kovnatsky, A. (2025). S.V.E. III: The Protocol for Academic Integrity. \textit{Preprint}.

\bibitem{shmidel_6351}
Shmidel, F. (2024). \textit{Internal Communication on Meaning and Will}. (Placeholder reference).

\bibitem{shmidel_6355_6356}
Shmidel, F. (2024). \textit{Personal correspondence on inner acts of will}. (Placeholder reference).

\bibitem{model_2721}
Kovnatsky, A. (2025). \textit{S.V.E. VIII: Divine Mathematics, Section 2.2}. (Placeholder for internal reference).

\bibitem{essence_6390_6391}
Kovnatsky, A. (2025). \textit{S.V.E. VIII: Divine Mathematics, Section 5.16}. (Placeholder for internal reference).

\bibitem{will_6397}
Kovnatsky, A. (2025). \textit{S.V.E. VIII: Divine Mathematics, Section 5.14}. (Placeholder for internal reference).

\bibitem{programming_6383_6384}
Kovnatsky, A. (2025). \textit{S.V.E. VIII: Divine Mathematics, Section 6.2}. (Placeholder for internal reference).

\bibitem{crutch_6384}
Kovnatsky, A. (2025). \textit{Author's Note on S.V.E. VIII}. (Placeholder for internal reference).

\bibitem{dissolution_6407_6408}
Kovnatsky, A. (2025). \textit{S.V.E. V: An Operating System for Verifiable Democracy}. (Placeholder for "Limited by Design" concept).

\bibitem{obsolescence_6415}
Kovnatsky, A. (2025). \textit{S.V.E. VIII: Divine Mathematics, Section 13.2}. (Placeholder for falsification criteria).

\bibitem{scaffold_6418}
Kovnatsky, A. (2025). \textit{Epilogue, S.V.E. VIII}. (Placeholder for internal reference).

\bibitem{fool_7735_7736}
Kovnatsky, A. (2025). \textit{S.V.E. VIII: Divine Mathematics, Section 10.4}. (Placeholder for "Socratic Дурак" concept).

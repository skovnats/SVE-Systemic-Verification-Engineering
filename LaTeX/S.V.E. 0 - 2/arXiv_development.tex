...
\begin{tikzpicture}[node distance=2.5cm, auto]
    % Stage 1
    \node[stage, fill=blue!20] (sources) {Input Sources\\$\{\vec{v}_1, \ldots, \vec{v}_N\}$};
    ...
    \node[vector] (purified) [below of=sip, yshift=-1.5cm] {Purified Vectors\\$\{\vec{v}^*_1, \ldots, \vec{v}^*_M\}$};
    ...
    \draw[arrow, blue, thick] (sources) -- node[above, font=\tiny] {selected sources} (sip);
...
\begin{tikzpicture}[
    dialogue/.style={rectangle, minimum width=2.5cm, minimum height=0.8cm,
                     text centered, draw=black, fill=blue!15, font=\tiny},
    verdict/.style={ellipse, minimum width=2cm, minimum height=0.6cm,
                    text centered, draw=black, fill=green!15, font=\tiny},
    meta/.style={rectangle, rounded corners, minimum width=3cm, minimum height=1cm,
                 text centered, draw=black, very thick, fill=yellow!20, font=\small},
    ...
    \draw[arrow, blue, thick] (v11) -- (meta);
    \draw[arrow, blue, thick] (v12) -- (meta);
    \draw[arrow, blue, thick] (v21) -- (meta);
    \draw[arrow, blue, thick] (v22) -- (meta);
    \draw[arrow, blue, thick] (v31) -- (meta);
    \draw[arrow, blue, thick] (v32) -- (meta);
...
H₀: \textit{``The statistical distribution of casualties and operational conduct in the SMO does not significantly differ from other 21st-century military conflicts.''}

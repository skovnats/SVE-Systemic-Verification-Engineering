...
% --- add (anywhere in preamble after xcolor)
\definecolor{HierarchyColor}{RGB}{0,114,178}
\definecolor{AnthillColor}{RGB}{213,94,0}
\definecolor{AccentColor}{RGB}{230,159,0} % if you need it later

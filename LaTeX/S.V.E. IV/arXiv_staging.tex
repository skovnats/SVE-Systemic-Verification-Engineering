...
\usepackage{xcolor}
\usepackage{titlesec}
\usetikzlibrary{positioning,arrows.meta,fit,calc,shadows,backgrounds,shapes.geometric,decorations.pathmorphing}
...
\begin{center}
    ...
    \href{https://codeberg.org/skovnats/SVE-Systemic-Verification-Engineering}
...
TRIZ & Theory of Inventive Problem Solving (Russian: \foreignlanguage{russian}{ТРИЗ}) \\
\bottomrule
\end{tabular}
...
\href{https://codeberg.org/skovnats/SVE-Systemic-Verification-Engineering/tree/master/Reviews}{github.com/skovnats/Reviews}
...
\begin{tikzpicture}[
    realm/.style={ellipse, minimum width=4cm, minimum height=2.5cm, 
                  text centered, draw=black, thick, font=\small\bfseries, align=center},
    interface/.style={rectangle, minimum width=3.5cm, minimum height=1.2cm,
                      text centered, draw=black, thick, fill=yellow!15, font=\small, align=center},
